        ...
        <div class="card-wrapper">
            ...
            <table v-if="!loading" class="table">
                ...
                <tr v-for="(businessrule, index) in businessrules">
                    <td><input class="fancyCheck" id="fancyCheckboxInput" type="checkbox" @click="toggleCheckedBusinessRule(businessrule.id)"> <label for="fancyCheckboxInput" class="check"> </label> </td>
