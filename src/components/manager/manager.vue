        ...
        <div class="card-wrapper">
            ...
            <table v-if="!loading" class="table">
                ...
                <tr v-for="(businessrule, index) in businessrules">
                    <td>
                        <div class="fancyCheckbox"><input id="fancyCheckboxInput" type="checkbox"
                                                          @click="toggleCheckedBusinessRule(businessrule.id)"> <label
                                for="fancyCheckboxInput"> </label></div>
                    </td>
                ...
                <tr>
                    <td><input id="fancyCheckboxInput" type="checkbox"> <label for="fancyCheckboxInput" class="check">
